            ...
            <div>
              <p style={{ color: "grey" }}>
                ...
                <span style={{ color: "black" }}>
                  <img src={Avatar} alt="ava" style={{ marginRight: "4px", marginLeft: "3px", width: "1.5rem", height: "1.5rem", borderRadius: "80px" }} /> {dataVilla.host}
                </span>
              </p>
            </div>
            <hr
          ...
          <Col sm={4} md={5}>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div>
                  <Image src={AvaCentang} alt="avacentang" style={{ height: "4rem", width: "4rem", borderRadius: "80px" }} />
                </div>
              </div>
              <div>
