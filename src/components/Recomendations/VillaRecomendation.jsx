        ...
        <Row>
          ...
          <Col xs={3} md={2} lg={1}>
            <div className="d-none d-sm-block">
              <img onClick={isPrevDisabled ? null : handlePrev} disabled={startIndex === 0} className="me-2" src={LeftArrow} alt="Left Arrow" style={{ cursor: "pointer" }} />
              <img onClick={isNextDisabled ? null : handleNext} disabled={startIndex + cardsPerPage >= cards.length} src={RightArrow} alt="Right Arrow" style={{ cursor: "pointer" }} />
            </div>
          </Col>
        </Row>
        <Row>
