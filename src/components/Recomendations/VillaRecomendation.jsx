        ...
        <Row>
          ...
          <Col xs={3} md={2} lg={1}>
            <div className="d-none d-sm-block">
              ...
              <img onClick={isNextDisabled ? null : handleNext} disabled={startIndex + cardsPerPage >= cards.length} src={RightArrow} alt="Right Arrow" />
            </div>
          </Col>
        </Row>
        <Row>
                      ...
                      {cardSubset.map((card, cardIndex) => (
                        <Col key={cardIndex} md={4} lg={3}>
                          <Card className="w-100" style={{ border: "none" }}>
                            ...
                            >
                              <p className="text-white mb-0 mt-0" style={{ fontSize: "13px" }}>
                                20% OFF
                              </p>
                            </div>
                            <Card.Body>
